...
export const CLIENT_NOT_FOUND = 'apiMessage.clientNotFound';
export const PRODUCT_NOT_FOUND = 'apiMessage.productNotFound';
export const USER_EXIST = 'apiMessage.userExist';
export const API_NOT_FOUND = 'apiMessage.notFound';
export const API_INFORMATION_NOT_FOUND = 'apiMessage.informationNotFound';
export const USER_WITHOUT_EMAIL = 'apiMessage.userWithoutEmail';
export const CLIENT_WITHOUT_EMAIL = 'apiMessage.clientWithoutEmail';
export const EMAIL_INVALID = 'apiMessage.invalidEmail';

export const UNAUTHORIZED_RESOURCE = '401000: Insufficient permission';
export const INVALID_CREDENTIALS = 'credential.invalid';
export const PASSWORD_INVALID = 'password.error';
export const INVALID_MFA_CODE = '401002: Invalid one-time code';
export const INVALID_TOKEN = '401003: Invalid token';
export const UNVERIFIED_EMAIL = 'apiMessage.email.isNotVerified';
...
export const EMAIL_USER_CONFLICT = 'apiMessage.emailExist';
...
export const ENTITY_CONFLICT = 'apiMessage.entityExist';

export const RATE_LIMIT_EXCEEDED = '429000: Rate limit exceeded';
export const EMAIL_NOT_SENT = 'apiMessage.emailNotSend';
